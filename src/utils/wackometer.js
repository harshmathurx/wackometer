...
export function rank(tweet) {
    ...
    const rules = [
        elon(tweetData.tweet,tweetData.sentiment),
        tesla(tweetData.tweet,tweetData.sentiment),
        emojis(tweetData.tweet,tweetData.sentiment),
        sentiment(tweetData.tweet,tweetData.sentiment),
        thread(tweetData.tweet,tweetData.sentiment),
        lineBreaks(tweetData.tweet,tweetData.sentiment),
        confidence(tweetData.tweet,tweetData.sentiment),
        noDoubt(tweetData.tweet,tweetData.sentiment),
        exclamations(tweetData.tweet,tweetData.sentiment),
        questions(tweetData.tweet,tweetData.sentiment),
        lowercase(tweetData.tweet,tweetData.sentiment),
        uppercase(tweetData.tweet,tweetData.sentiment),
        hazing(tweetData.tweet,tweetData.sentiment),
    ]
 ...
 */
function tesla(tweet, sentiment) {
 ...
 */
function emojis(tweet, sentiment) {
    const emojis = [
        "🚀",
        "💫",
        "🚘",
 ...
 */
function sentiment(tweet, sentiment) {
 ...
 */
function thread(tweet, sentiment) {
 ...
 */
function lineBreaks(tweet, sentiment) {
 ...
 */
function confidence(tweet, sentiment) {
    const phrases = [
        "definitely",
        "only ",
        "must",
 ...
 */
function noDoubt(tweet, sentiment) {
 ...
 * Be bold and loud!
 */
function exclamations(tweet, sentiment) {
 ...
 * Don't ask questions!
 */
function questions(tweet, sentiment) {
    const regex = new RegExp(`\\?`, "gi")
 ...
 */
function lowercase(originalTweet) {
 ...
 */
function uppercase(originalTweet) {
 ...
 */
function hazing(tweet, sentiment) {
